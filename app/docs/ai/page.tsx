  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-6">
        ...
        <a href="https://taxsnapai.app" className="text-blue-600 hover:text-blue-800">
          https://taxsnapai.app
        </a>
      </p>

      <p className="text-gray-700 leading-relaxed mb-6">
        At TaxSnapAI, we use artificial intelligence (&quot;AI&quot;) to power the core features of our platform. This
        document outlines how and why we use AI technologies, what data is processed, and how it may affect you as a
        user.
      </p>

      <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">1. Purpose of AI in TaxSnapAI</h2>
      <p className="text-gray-700 leading-relaxed mb-3">AI is essential to the TaxSnapAI experience. It is used for:</p>
      ...
      <p className="bg-amber-50 p-4 rounded-lg border border-amber-200 mb-4">
        ...
        before transmission. By using TaxSnapAI, you acknowledge and consent to this transfer.
      </p>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        AI processing is a fundamental component of TaxSnapAI and cannot be disabled. If you do not consent to your data
      ...
      <p className="bg-red-50 p-4 rounded-lg border border-red-200 mb-6">
        <strong className="text-red-600">⚠️ Important:</strong> TaxSnapAI is <strong>not a substitute</strong> for a
